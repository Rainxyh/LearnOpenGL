...
float exposure = 1.0f;
unsigned int gaussianbluramount = 10;
...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glBindFramebuffer(GL_FRAMEBUFFER, 0);
        // Not what I consider a good result. The reasons are:
        ...
        // What we need is to keep some sharpness of the smaller kernels but also have the wide spread of the big kernels.
